...
modelWeights = 'yolov3.weights' #On peut utiliser Yolov3-tiny pour la vitesse des FPS mais Yolov3 pour plus de précision 
...
cap = cv.VideoCapture('driving4.mp4') #We can put any video we want

while cv.waitKey(1) < 0:

    #get frame from video
    hasFrame, frame = cap.read()
    #l'image de Mon WebCam me parait inverse donc j'aurai du l'invertir
